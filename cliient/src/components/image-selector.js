...
import { PreviousImageSelector } from "./previous-image-selector";
...
export default function ImageSelector(props) {
  ...
  <TabPanel value="1">
    <PreviousImageSelector imageArray={imageArray} dispImg={dispImg} handleSelect={handleSelect} />

  </TabPanel>
  <TabPanel value="2">
  <DefaultImageSelector imageArray={imageArray} dispImg={dispImg} handleSelect={handleSelect} />
  </TabPanel>
